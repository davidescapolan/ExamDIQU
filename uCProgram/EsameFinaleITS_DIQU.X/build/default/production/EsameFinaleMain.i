...
# 2 "<built-in>" 2
# 1 "EsameFinaleMain.c" 2
# 10 "EsameFinaleMain.c"
...
void UART_Init(long int baudRate){
    ...
    SPBRG= (char) (8000000/(unsigned long int) (64UL * (unsigned long int)baudRate))-1;
...
# 283 "EsameFinaleMain.c"
void LCD_Send(char data, char mode){
    PORTE |= 0X02;
    PORTD = data;
    (mode) ? (PORTE = PORTE & ~0X04) : (PORTE |= 0X04);
